...
description: "Documentation for the React component library used in the PromptReady extension, including core components, custom hooks, and state management patterns."
context: "This document provides a comprehensive overview of the React components and custom hooks that make up the PromptReady extension\'s user interface. It details the architecture, props, and usage of each component, as well as the state management and testing strategies employed."
---
