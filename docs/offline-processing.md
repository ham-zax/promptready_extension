---
title: "Offline Processing Pipeline"
description: "The architecture, design principles, and evolutionary history of the PromptReady offline content processing pipeline."
context: "This document provides a detailed overview of the offline processing pipeline, which intelligently extracts and converts webpage content into clean, structured Markdown. It covers the hybrid pipeline architecture, the two main processing paths, the evolution of the pipeline, and key modules and responsibilities."
---
