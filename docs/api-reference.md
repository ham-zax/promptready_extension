---
title: "API Reference"
description: "A comprehensive reference for all APIs used in the PromptReady extension, including core processing APIs, extension messaging APIs, and backend service APIs."
context: "This document provides detailed information about the various APIs that power the PromptReady extension. It is intended for developers who need to understand the extension's architecture and how its different components interact."
---
