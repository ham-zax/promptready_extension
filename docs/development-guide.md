...
description: "A comprehensive guide for setting up, developing, testing, and deploying the PromptReady extension."
context: "This document provides detailed instructions for developers working on the PromptReady extension. It covers prerequisites, local development setup, project structure, testing strategies, code quality guidelines, and deployment processes for both the extension and the backend services."
---
