---
title: "User Guide"
description: "A comprehensive guide for users of the PromptReady extension, covering installation, usage, features, and troubleshooting."
context: "This document provides a complete user guide for the PromptReady extension. It explains how to get started, how to use the different processing modes, and how to configure advanced settings. It also includes a troubleshooting section to help users resolve common issues."
---
