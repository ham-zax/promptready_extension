  ...
  return (
    <div className="w-full min-w-0 space-y-4">
      <div className="text-center">
        <div className="w-10 h-10 bg-brand-surface text-brand-primary rounded-lg flex items-center justify-center mx-auto mb-2 border border-brand-border">
      ...
      <div>
        ...
        <div className="p-2.5 rounded-lg border border-brand-border bg-brand-surface">
          <div className="flex items-center space-x-3">
            <div className="p-1.5 rounded-md bg-white transition-colors">
      ...
      <div className="space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition-all shadow-sm"
          />
        </div>
      ...
      <div className="flex flex-col space-y-2">
        <button
          ...
          className="w-full py-2.5 bg-brand-primary text-brand-primary-foreground font-semibold rounded-md hover:opacity-90 active:scale-[0.98] disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed transition-all shadow-sm"
        >
          Save API Key
        </button>
        ...
        <div className="flex space-x-2">
          <button
            onClick={onCancel}
            className="flex-1 py-2 bg-white border border-gray-200 text-gray-700 font-medium rounded-md hover:bg-gray-50 active:scale-[0.98] transition-all text-sm"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 py-2 bg-gray-100 text-gray-700 font-medium rounded-md hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] transition-all text-sm"
          >
